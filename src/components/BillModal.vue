    ...
    <form @submit.prevent="submitForm" class="bill-content">
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="input flex flex-column">
          ...
          <input v-model="form.billerAddress" type="text" id="billerAddress" required />
        </div>
        <div class="location-details flex">
          <div class="input flex flex-column">
            <label for="billerCity">City</label>
            <input v-model="form.billerCity" type="text" id="billerCity" required />
          </div>
          <div class="input flex flex-column">
            <label for="billerZipCode">Zip Code</label>
            <input v-model="form.billerZipCode" type="text" id="billerZipCode" required />
          </div>
          <div class="input flex flex-column">
            <label for="billerCountry">Country</label>
            <input v-model="form.billerCountry" type="text" id="billerCountry" required />
          </div>
        </div>
      </div>
      <!-- Bill to -->
      <div class="bill-to flex flex-column">
        ...
        <div class="input flex flex-column">
          ...
          <input v-model="form.clientName" type="text" id="clientName" required />
        </div>
        <div class="input flex flex-column">
          <label for="clientEmail">Client's Email</label>
          <input v-model="form.clientEmail" type="text" id="clientEmail" required />
        </div>
        <div class="input flex flex-column">
          <label for="clientAddress">Street Address</label>
          <input v-model="form.clientAddress" type="text" id="clientAddress" required />
        </div>

        <div class="location-details flex">
          <div class="input flex flex-column">
            <label for="clientCity">City</label>
            <input v-model="form.clientCity" type="text" id="clientCity" required />
          </div>
          <div class="input flex flex-column">
            <label for="clientZipCode">Zip Code</label>
            <input v-model="form.clientZipCode" type="text" id="clientZipCode" required />
          </div>
          <div class="input flex flex-column">
            <label for="clientCountry">Country</label>
            <input v-model="form.clientCountry" type="text" id="clientCountry" required />
          </div>
        </div>
      </div>
      <!-- Bill details -->
      <div class="bill-work flex flex-column">
        ...
        <div class="input flex flex-column">
          ...
          <input v-model="form.productDescription" type="text" id="productDescription" required />
        </div>
